...
<section class="section dashboard">
  <div class="row">
        ...
        <div class="card">
  <div class="card-body">
    <h5 class="card-title">Add Room Label</h5>
   
    <!-- Custom Styled Validation -->
    <form action="{{route('store.label')}}" method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
      @csrf
      <div class="col-md-12s">
        <label for="validationCustom01" class="form-label">Room Label</label>
        <input type="text" class="form-control" name="room_label" id="validationCustom01" placeholder="Room Label"  required>
      ...
      <div class="col-12">
        <button class="btn btn-primary" type="submit">Add Room Label</button>
      </div>
